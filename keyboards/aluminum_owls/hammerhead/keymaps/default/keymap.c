...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BSE] = LAYOUT(
        ...
        KC_TAB,         KC_A,           KC_R,       KC_S,       KC_T,       KC_G,       CW_TOGG,
        KC_LCTL,        ALT_T(KC_Z),    KC_X,       KC_C,       KC_D,       KC_V,       KC_LCMD,
                                                                KC_BSPC,    OSL(SYM),   OS_LSFT,

                        KC_J,           KC_L,       KC_U,       KC_Y,       KC_0,       UG_HUEU,
        KC_PGUP,        KC_M,           KC_N,       KC_E,       KC_I,       KC_O,       KC_ENT,
        KC_PGDN,        KC_K,           KC_H,       KC_COMM,    KC_DOT,     KC_QUOT,    OSL(FN),
    ...
    [SYM] = LAYOUT(
        ...
        KC_TRNS,        KC_EXLM,        KC_ASTR,    KC_SLSH,    KC_EQL,     KC_AMPR,    KC_TRNS,
        KC_TRNS,        KC_TILD,        KC_PLUS,    KC_LBRC,    KC_RBRC,    KC_PERC,    KC_TRNS,
                                                                KC_TRNS,    KC_TRNS,    KC_TRNS,

                        KC_CIRC,        KC_LCBR,    KC_RCBR,    KC_DLR,     KC_BSLS,    KC_TRNS,
        KC_TRNS,        KC_HASH,        KC_LPRN,    KC_RPRN,    KC_COLN,    KC_DQUO,    KC_TRNS,
        KC_TRNS,        KC_AT,          KC_SCLN,    KC_COMM,    KC_DOT,     KC_QUES,    KC_TRNS,
